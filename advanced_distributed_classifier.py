...
# replica device setter will place ops in the appropriate devices
with tf.device(
    ...
    with tf.name_scope('train'):
        ...
        # Wrap the optimizer in a SyncReplicasOptimizer for distributed training
        optimizer = tf.train.SyncReplicasOptimizer(tf.train.GradientDescentOptimizer(np.sqrt(num_workers) * lr), replicas_to_aggregate=num_workers)
